...
import kokellab.utils.misc.{FileHasher, SevenZipCommandLine, ValidationFailedException}
...
object DirectoryLoader extends LazyLogging {
	...
	def main(args: Array[String]): Unit = {
		val submission = DirectoryLoader.load(Paths.get(args(0)))
		Importer.insert(submission)
	}
}
