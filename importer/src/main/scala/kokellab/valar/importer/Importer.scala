...
import kokellab.utils.misc.FileHasher
...
import kokellab.valar.core.Tables.{SubmissionRecords, SubmissionsRow}
import kokellab.utils.grammars._
import kokellab.valar.params.layouts.post.{FullPlateInfo, PlateConstruction}
import kokellab.valar.core.ImageCodec
...
object Importer extends LazyLogging {
	...
	def insert(result: SubmissionResult): Unit = {
